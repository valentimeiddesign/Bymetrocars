...
import { HomeAbout, HomeLending, HomeCTA } from './components/HomeInfoSections';
...
export default function App() {
  ...
  const navigateTo = (page: string, carId?: string | number) => {
    setCurrentPage(page);
    if (carId !== undefined) {
      ...
      <div className="min-h-screen w-full bg-white">
        ...
        <div className="text-[rgb(51,_51,_51)] text-[14px] leading-[20px]" style={{"fontFamily":"Figtree, sans-serif"}}>
          ...
          <Header
            ...
            allCars={allHomeCars}
          />
          <Locations onNavigate={navigateTo} setSelectedLocation={setSelectedLocation} />
          <Footer onNavigate={navigateTo} />
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen w-full bg-white">
      ...
      <div className="text-[rgb(51,_51,_51)] text-[14px] leading-[20px]" style={{"fontFamily":"Figtree, sans-serif"}}>
        ...
        {/* Hero Section */}
        <section className="py-4" style={{"backgroundImage":"linear-gradient(rgb(250, 250, 253), rgba(250, 250, 253, 0))"}}>
          <div className="w-full max-w-[2304px] mx-auto px-4 md:px-8 lg:px-20 2xl:px-32 pt-[24px] bg-[rgba(248,248,252,0)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 mb-8 gap-4">
              ...
              >
                <div>
                  <h3 className="text-[32px] font-bold text-white mb-4">Financing</h3>
                ...
                <div className="flex items-end justify-between mt-8">
                  <div className="flex flex-col items-start">
                    <div className="text-sm text-white/80 italic mb-4">This will NOT impact your Credit</div>
                  ...
                  <div className="bg-white px-4 py-2 rounded border border-gray-200 mb-1">
                    <span className="text-[#D82C2C] font-bold tracking-wider text-xl" style={{fontFamily: 'serif'}}>EQUIFAX</span>
                  </div>
                </div>
              </div>
              ...
              >
                <div>
                  <h3 className="text-[32px] font-bold text-[rgb(5,_15,_35)] mb-4">Trade-in</h3>
                  <p className="text-[rgb(5,_15,_35)] text-lg">Just in a few clicks.</p>
                </div>
